...
# <div class="toc"><ul class="toc-item"><li><span><a href="#Strings,-Lists,-Arrays,-and-Dictionaries" data-toc-modified-id="Strings,-Lists,-Arrays,-and-Dictionaries-1"><span class="toc-item-num">1&nbsp;&nbsp;</span>Strings, Lists, Arrays, and Dictionaries</a></span><ul class="toc-item"><li><span><a href="#Strings" data-toc-modified-id="Strings-1.1"><span class="toc-item-num">1.1&nbsp;&nbsp;</span>Strings</a></span></li><li><span><a href="#Lists" data-toc-modified-id="Lists-1.2"><span class="toc-item-num">1.2&nbsp;&nbsp;</span>Lists</a></span><ul class="toc-item"><li><span><a href="#Slicing-lists" data-toc-modified-id="Slicing-lists-1.2.1"><span class="toc-item-num">1.2.1&nbsp;&nbsp;</span>Slicing lists</a></span></li><li><span><a href="#Creating-and-modifying-lists" data-toc-modified-id="Creating-and-modifying-lists-1.2.2"><span class="toc-item-num">1.2.2&nbsp;&nbsp;</span>Creating and modifying lists</a></span></li><li><span><a href="#Tuples" data-toc-modified-id="Tuples-1.2.3"><span class="toc-item-num">1.2.3&nbsp;&nbsp;</span>Tuples</a></span></li><li><span><a href="#Multidimensional-lists-and-tuples" data-toc-modified-id="Multidimensional-lists-and-tuples-1.2.4"><span class="toc-item-num">1.2.4&nbsp;&nbsp;</span>Multidimensional lists and tuples</a></span></li></ul></li><li><span><a href="#NumPy-arrays" data-toc-modified-id="NumPy-arrays-1.3"><span class="toc-item-num">1.3&nbsp;&nbsp;</span>NumPy arrays</a></span><ul class="toc-item"><li><span><a href="#Creating-arrays-(1-d)" data-toc-modified-id="Creating-arrays-(1-d)-1.3.1"><span class="toc-item-num">1.3.1&nbsp;&nbsp;</span>Creating arrays (1-d)</a></span></li><li><span><a href="#Mathematical-operations-with-arrays" data-toc-modified-id="Mathematical-operations-with-arrays-1.3.2"><span class="toc-item-num">1.3.2&nbsp;&nbsp;</span>Mathematical operations with arrays</a></span></li><li><span><a href="#Slicing-and-addressing-arrays" data-toc-modified-id="Slicing-and-addressing-arrays-1.3.3"><span class="toc-item-num">1.3.3&nbsp;&nbsp;</span>Slicing and addressing arrays</a></span></li><li><span><a href="#Multi-dimensional-arrays-and-matrices" data-toc-modified-id="Multi-dimensional-arrays-and-matrices-1.3.4"><span class="toc-item-num">1.3.4&nbsp;&nbsp;</span>Multi-dimensional arrays and matrices</a></span></li><li><span><a href="#Differences-between-lists-and-arrays" data-toc-modified-id="Differences-between-lists-and-arrays-1.3.5"><span class="toc-item-num">1.3.5&nbsp;&nbsp;</span>Differences between lists and arrays</a></span></li></ul></li><li><span><a href="#Dictionaries" data-toc-modified-id="Dictionaries-1.4"><span class="toc-item-num">1.4&nbsp;&nbsp;</span>Dictionaries</a></span></li><li><span><a href="#Random-numbers" data-toc-modified-id="Random-numbers-1.5"><span class="toc-item-num">1.5&nbsp;&nbsp;</span>Random numbers</a></span><ul class="toc-item"><li><span><a href="#Uniformly-distributed-random-numbers" data-toc-modified-id="Uniformly-distributed-random-numbers-1.5.1"><span class="toc-item-num">1.5.1&nbsp;&nbsp;</span>Uniformly distributed random numbers</a></span></li><li><span><a href="#Normally-distributed-random-numbers" data-toc-modified-id="Normally-distributed-random-numbers-1.5.2"><span class="toc-item-num">1.5.2&nbsp;&nbsp;</span>Normally distributed random numbers</a></span></li><li><span><a href="#Random-distribution-of-integers" data-toc-modified-id="Random-distribution-of-integers-1.5.3"><span class="toc-item-num">1.5.3&nbsp;&nbsp;</span>Random distribution of integers</a></span></li><li><span><a href="#Loading-random-number-functions" data-toc-modified-id="Loading-random-number-functions-1.5.4"><span class="toc-item-num">1.5.4&nbsp;&nbsp;</span>Loading random number functions</a></span></li></ul></li><li><span><a href="#Exercises" data-toc-modified-id="Exercises-1.6"><span class="toc-item-num">1.6&nbsp;&nbsp;</span>Exercises</a></span></li></ul></li></ul></div>
