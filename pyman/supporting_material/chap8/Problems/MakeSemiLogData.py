...
fout.write("Data for decay of voltage across an inductor\n")
fout.write("in an RL circuit\n")
fout.write("Date: 24-Oct-2012\n")
fout.write("Data taken by D. M. Blantogg and T. P. Chaitor\n\n")
